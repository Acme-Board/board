...
class GameModelTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.game = Game(name='BANG', description='descripcion', status=Status.PE, price=2.5, picture='http://www.foto.com/foto.png', owner=self.user)
        self.game.save()
...
class RentModelTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.game = Game(name = 'BANG', description = 'descripcion', status = Status.PE, price = 2.5, picture = 'http://www.foto.com/foto.png', owner = self.user1)
        self.game.save()
