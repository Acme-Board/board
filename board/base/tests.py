...
class Register(unittest.TestCase):
    ...
    def test_register(self):
        ...
        driver.find_element_by_id("id_username").clear()
        driver.find_element_by_id("id_username").send_keys("Beatriz")
        ...
        driver.find_element_by_id("id_name").send_keys("Beatriz")
        driver.find_element_by_id("id_last_name").clear()
        driver.find_element_by_id("id_last_name").send_keys("Tricia")
        driver.find_element_by_id("id_email").clear()
        driver.find_element_by_id("id_email").send_keys("bea@gmail.com")
        driver.find_element_by_id("id_bio").clear()
        driver.find_element_by_id("id_bio").send_keys("Hola, soy bea.")
        driver.find_element_by_id("id_picture").click()
        driver.find_element_by_id("id_picture").clear()
        driver.find_element_by_id("id_picture").send_keys("C:\\fakepath\\DyxmCipX0Ac05NG.jpg")
