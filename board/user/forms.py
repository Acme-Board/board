...
class Register(forms.Form):
    ...
    phone = forms.CharField(label='Teléfono*', validators=[RegexValidator(r'^[0-9].{9,}$', 'El numero de telefono deben ser entre 9 y 10 digitos')], max_length=10, required=True,
